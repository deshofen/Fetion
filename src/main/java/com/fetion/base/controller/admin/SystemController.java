...
import com.fetion.base.service.admin.DatabaseBakService;
import com.fetion.base.service.admin.OperaterLogService;
import com.fetion.base.service.admin.OrderAuthService;
import com.fetion.base.service.admin.UserService;
...
public class SystemController {
	...
	public Result<Boolean> login(HttpServletRequest request,User user,String cpacha){
		...
		frontUtil.setLoginedUser(SystemTypeEnum.ADMIN,findByUsername);
...
//		}
		...
		if (user != null) {
			frontUtil.delLoginedUser(SystemTypeEnum.ADMIN);
		}
	...
	public String updateUserInfo(User user){
		User loginedUser = frontUtil.getLoginedUser(SystemTypeEnum.ADMIN);//SessionUtil.getLoginedUser();
		loginedUser.setEmail(user.getEmail());
		loginedUser.setMobile(user.getMobile());
		loginedUser.setHeadPic(user.getHeadPic());
		//首先保存到数据库
		userService.updateById(loginedUser);
		//更新session里的值
		SessionUtil.set(SessionConstant.SESSION_USER_LOGIN_KEY, loginedUser);
		frontUtil.setLoginedUser(SystemTypeEnum.ADMIN,loginedUser);
	...
	public Result<Boolean> authOrder(@RequestParam(name="orderSn",required=true)String orderSn,@RequestParam(name="phone",required=true)String phone){
		...
		orderAuthService.insert(orderAuth);
