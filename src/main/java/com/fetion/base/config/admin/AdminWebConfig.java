package com.fetion.base.config.admin;
/**
 * 用来配置拦截器的配置类
 */
...
import com.fetion.base.constant.RuntimeConstant;
import com.fetion.base.interceptor.admin.AdminAuthorityInterceptor;
import com.fetion.base.interceptor.admin.AdminLoginInterceptor;
@Configuration
