...
<body class="vertical-layout">
    <!-- Start Containerbar -->
    <div id="containerbar" class="containerbar authenticate-bg" style="background: url('/admin/images/img-slide-3.jpg')">
        <!-- Start Container -->
        <div class="container">
            <div class="auth-box login-box">
                ...
                <div class="row no-gutters align-items-center justify-content-center">
                    <!-- Start col -->
                    <div class="col-md-6 col-lg-5" style="border: double">
                        <!-- Start Auth Box -->
...
<#--                                        </div>-->
                                        ...
                                        <div class="form-group">
                                            <div class="profilebar">
                                                <img class="profile-pic img-fluid" style="height: 100px;" id="user-center-img" src="/photo/view?filename=default.png" data-img="default.png" alt="profile-pic">
                                                <div class="profile-edit">
                                                    <i class="feather icon-camera upload-button"></i>
                                                    <input type="hidden" id="user-head-pic" value="default.png">
                                                    <input class="profile-upload"  type="file" id="user-photo-file" accept="image/*" style="display: none"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-sm-12">
                                                <div class="custom-control custom-checkbox text-left">
                                                    ...
                                                    <label class="custom-control-label font-14" for="terms">我同意<a href="javascript:void(0)" id="show-policy">《飞信聊天室政策》</a></label>
                                                </div>
                                            </div>
                                        </div>
                                      <a href="javascript:void(0)" class="btn btn-success btn-lg btn-block font-18" style="background-color: #007bffc2" id="submit-btn">立即注册</a>
                                    </form>
...
$(document).ready(function(){
	$("#submit-btn").click(function(){
        ...
        if($("#user-photo-file").val() == ''){
            ...
            uploadFileToServer('user-photo-file',function(result){
                $("#user-head-pic").val(result.data);
                $.ajax({
                    url:'register',
                    type:'POST',
                    data:{username:username,password:password,email:email,headPic:result.data},
                    dataType:'json',
                    success:function(data){
                        if(data.code == 0){
                            layer.msg('注册成功，请登录！');
