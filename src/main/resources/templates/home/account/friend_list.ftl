...
<#if from == 0>
	<#list accountGroupMemberList as accountGroupMember>
		<a class="nav-link friend-account1" id="new-group-chat-${accountGroupMember.id}-tab" data-toggle="pill" href="#" role="tab" aria-selected="true" group-id="${accountGroupMember.id}" groupname="${accountGroupMember.name}" grouppeople="${accountGroupMember.curPeople}" grouppicture="${accountGroupMember.picture}" >
			<div class="media">
...
<script>
	...
	//点击聊天室事件
	$(".friend-account1").click(function(){
