...
<div class="chat-user-body" style="z-index: 1">
    <div class="userbar">
        ...
        <p class="mb-0">
            ...
            <#if base_account.id == accountGroup.admin.id>
                <span style="margin-left:5px;cursor:pointer;" title="点击修改聊天室简介" data-toggle="tooltip" id="edit-group-info-btn"><i class="feather icon-edit-2"></i></span>
            </#if>
        </p>
    </div>
    <div class="user-detail">
        ...
        <div class="user-about">
            ...
            <h6 style="font-weight:550;margin-bottom:12px;"><span id="show-group-name">${accountGroup.name}</span>
                <#if base_account.id == accountGroup.admin.id>
                    <span style="margin-left:5px;cursor:pointer;" title="点击修改聊天室名称" data-toggle="tooltip" id="edit-group-name-btn"><i class="feather icon-edit-2"></i></span>
                </#if>
            </h6>
        ...
        <div class="user-setting" style="padding-bottom:0px;margin-bottom:0px;">
            ...
            <#else>
                <div class="row align-items-center pb-3" style="text-align:center;">
                    <#if flag=="false">
                        <div class="col-12"><input type="button" class="btn btn-danger" id="join-group-chat-btn" value="立即加入" style="width:100%;"></div>
                    <#else>
                        <div class="col-12">
