...
<head>
    ...
    <link rel="stylesheet" href="/home/layui/css/layui.css" tppabs="/home/layui/css/layui.css"  media="all">
    <!-- End css -->
</head>
<style>
    .icon-smile {
        background: url("/home/images/smile.svg");
        background-repeat: no-repeat;
    }

    #chat-list-tab-top .top_chat{
        display: none;
    }
    #chat-list-tab .bottom_chat{
        display: none;
    }
    #search-chat-list-tab .top_chat{
        display: none;
    }
    #search-chat-list-tab .bottom_chat{
        display: none;
    }
    .layui-form-mid1 {
        position: relative;
...
<body class="light-layout" style="max-height: 100%;overflow: hidden;">
<div class="modal create-group-modal fade" id="createPubGroup" tabindex="-1" role="dialog" aria-labelledby="createGroupTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createGroupTitle">创建公共聊天室</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <input type="text" class="form-control" id="pubgroupName" placeholder="输入聊天室名称">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" name="groupDesc" id="pubgroupDesc" rows="3" placeholder="输入简单介绍"></textarea>
                    </div>
                    <div class="added-users" style="display: none">
                        <div class="avatar-group" id="selected-chat-pub-group-users" style="display:block;">

                        </div>
                    </div>
                    <div class="add-users-list" style="display: none">
                        <ul class="list-unstyled" id="create-pub-group-chat-show-friends">

                        </ul>
                    </div>
                    <div class="mt-3 text-center">
                        <button type="button" class="btn btn-primary" id="create-pub-group-submit-btn"><i class="feather icon-plus mr-2"></i>创建聊天室</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal create-group-modal fade" id="createGroup" tabindex="-1" role="dialog" aria-labelledby="createGroupTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createGroupTitle">创建聊天室</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <input type="text" class="form-control" id="groupName" placeholder="输入聊天室名称">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mt-3 text-center">
                        <button type="button" class="btn btn-primary" id="create-group-submit-btn"><i class="feather icon-plus mr-2"></i>创建聊天室</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal create-group-modal fade" id="add-group-user" role="dialog" aria-labelledby="addGroupUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addGroupUserTitle">添加聊天室成员</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="add-users-list">
...
<div class="modal create-group-modal fade" id="reduce-group-user" role="dialog" aria-labelledby="addGroupUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="reduceGroupUserTitle">移除聊天室成员</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="add-users-list">
...
<div class="modal create-group-modal fade" id="reduce-mStatus-user" role="dialog" aria-labelledby="addGroupUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="reduceGroupUserTitle">禁言聊天室成员</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="add-users-list">
                        <ul class="list-unstyled" id="show-mStatus-user-list">

                        </ul>
                    </div>
                    <div class="mt-3 text-center">
                        <button type="button" class="btn btn-primary" id="reduce-mStatus-users-submit-btn"><i class="feather icon-plus mr-2"></i>确定禁言</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal create-group-modal fade" id="a-reduce-mStatus-user" role="dialog" aria-labelledby="addGroupUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="reduceGroupUserTitle">解除禁言</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="add-users-list">
                        <ul class="list-unstyled" id="a-show-mStatus-user-list">

                        </ul>
                    </div>
                    <div class="mt-3 text-center">
                        <button type="button" class="btn btn-primary" id="a-reduce-mStatus-users-submit-btn"><i class="feather icon-plus mr-2"></i>确定解除</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal create-group-modal fade" id="new-group-request-tab-show" role="dialog" aria-labelledby="addGroupUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addGroupUserTitle">收到的添加聊天室请求</h5>
            </div>
            <div class="modal-body">
                <form>
                    <div class="add-users-list">
                        <ul class="list-unstyled" id="show-new-group-request-list">
                        </ul>
                    </div>
                    <div class="mt-3 text-center">
                        <button type="button" class="btn btn-primary new-group-request-handle-btn" status="1"><i class="feather icon-check mr-2"></i>批量通过</button>
                        <button type="button" class="btn btn-primary new-group-request-handle-btn" status="-1"><i class="feather icon-x mr-2"></i>批量拒绝</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="chat-layout">
    ...
    <div class="chat-leftbar">
        <div class="tab-content" id="pills-tab-justifiedContent">
            ...
            <!-- Start Chat Public -->
            <div class="tab-pane fade" id="pills-pubchat-justified" role="tabpanel" aria-labelledby="pills-addchat-tab-justified">
                <div class="chat-addbar">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mb-0 mt-2">公共聊天室</h5>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-3">
                                <#if base_account.type == "1">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="settingDropdown">
                                            <a class="dropdown-item font-14" href="javascript:void(0)" id="create-pub-group-chat-btn"><i class="feather icon-users"></i> 创建公共聊天室</a>
                                        </div>
                                    </div>
                                </#if>
                    ...
                    -->
                    <div class="chat-left-body" style="height: calc(100vh - 140px);padding-bottom: 0">
                        <div class="nav flex-column nav-pills chat-userlist" id="pub-chat-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="pub-friend-request-tab" data-toggle="pill" href="#" role="tab" aria-selected="true">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade show active" id="pills-chat-justified" role="tabpanel" aria-labelledby="pills-chat-tab-justified">
                <div class="chat-listbar">
                    ...
                    <div class="chat-left-search">
                        <form>
                            <#--                                <div class="input-group">-->
                            <#--                                  <input type="text" onKeyUp="searchInfo(this.value)" class="form-control" placeholder="搜索" aria-label="Search" aria-describedby="chat-left-search-btn">-->
                            <#--                                  <div class="input-group-append">-->
                            ...
                            <div class="layui-form-item" style="margin-bottom: 0px">
                                <div class="layui-input-inline" >
                                    <input type="text" onKeyUp="searchInfo(this.value)" name="title" lay-verify="title" autocomplete="off" placeholder="搜索" class="layui-input">
                                </div>
                                <div class="layui-form-mid1 layui-word-aux" >
                                    <button class="btn" type="button" id="chat-left-search-btn"><i class="feather icon-search"></i></button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="chat-left-body" style="height: calc(100vh - 140px);padding-bottom: 0">
                        <div class="nav flex-column nav-pills chat-userlist" id="chat-list-tab-top" role="tablist" aria-orientation="vertical">
                ...
                <div class="chat-addbar">
                            ...
                            <div class="col-3">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="settingDropdown">
                                        ...
                                        <a class="dropdown-item font-14" href="javascript:void(0)" id="create-group-chat-btn"><i class="feather icon-users"></i> 创建聊天室</a>
                                    </div>
                                </div>
                    ...
                    <div class="chat-left-body" style="height: calc(100vh - 140px);padding-bottom: 0">
                        <div class="nav flex-column nav-pills chat-userlist" id="new-chat-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="a-pub-friend-request-tab" data-toggle="pill" href="#" role="tab" aria-selected="true">
                                <div class="media">
                                    <img class="align-self-center rounded-circle" src="/home/images/new-request.png" alt="User Image">
                                    <div class="media-body">
                                        <h5 id="show-new-group-request-num">聊天室请求</h5>
                                        <p id="show-new-group-request-text">没有新的加聊天室请求.</p>
                                    </div>
                ...
                <div class="chat-profilebar">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <input type="hidden" id="current-online-user-id" value="${base_account.id}">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="chat-left-body" style="height: calc(100vh - 140px);padding-bottom: 0">
                        <div class="profilebar">
                            <img class="profile-pic img-fluid" style="height: 100px;" id="user-center-img" src="/photo/view?filename=${base_account.headPic!"default.png"}" data-img="${base_account.headPic!"default.png"}" alt="profile-pic">
                            <div class="profile-edit">
                                <i class="feather icon-camera upload-button"></i>
                                <input type="hidden" id="user-head-pic" value="${base_account.headPic!"default.png"}">
                                <input class="profile-upload" type="file" id="user-photo-file" onchange="uploadFile()" accept="image/*"/>
                            </div>
                            <h5 id="show-user-name">${base_account.username}</h5>
                            <p class="mb-0" id="show-user-info">${base_account.info!"此人很懒，什么介绍也没写！"}</p>
                        </div>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>用户名</p>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="user-name" value="${base_account.username}" placeholder="请输入用户名" aria-label="${base_account.username}" aria-describedby="button-addon-group-username">
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>个人简介</p>
                                        <div class="input-group">
                                            <input type="text" class="form-control" maxlength="64" id="user-info" value="${base_account.info!""}" placeholder="请输入个人简介" aria-label="${base_account.info!""}" aria-describedby="button-addon-group-location">
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>在线状态</p>
                                        <div class="input-group">
                                            <a href="javascript:void(0)" id="online-status" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-key="${base_account.chatStatus!"status-offline"}">
                                                <#if base_account.chatStatus == "active"><font color="#19a299">●</font> 在线
                                                <#elseif base_account.chatStatus == "status-offline"><font color="#dee2e6">●</font> 离线
                                                <#elseif base_account.chatStatus == "status-away"><font color="#eec028">●</font> 离开
                                                </#if>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="online-status">
                                                ...
                                                <a class="dropdown-item font-14 status-change" data-key="status-offline" href="javascript:void(0)"><font color="#dee2e6">●</font> 隐身</a>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>性别</p>
                                        <div class="input-group">
                                            <a href="javascript:void(0)" id="user-sex" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-key="${base_account.sex!"0"}">
                                                <#if base_account.sex == 1><font color="#19a299">♂</font> 男
                                                <#elseif base_account.sex == 2><font color="#19a299">♀</font> 女
                                                <#elseif base_account.sex == 0><font color="#dee2e6">？</font> 未知
                                                </#if>
                                            </a>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>手机号</p>
                                        <div class="input-group">
                                            <input type="tel" class="form-control" maxlength="11" id="user-mobile" value="${base_account.mobile!""}" placeholder="请输入手机号" aria-label="${base_account.mobile!""}" aria-describedby="button-addon-group-emailid">
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>邮箱</p>
                                        <div class="input-group">
                                            <input type="email" class="form-control" id="user-email" value="${base_account.email!""}" placeholder="请输入邮箱" aria-label="${base_account.email!""}" aria-describedby="button-addon-group-emailid">
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
        ...
        <div class="chat-menu" >
            <ul class="nav nav-pills nav-justified mb-0" id="pills-tab-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="pills-pubchat-justified" data-toggle="pill" href="#pills-pubchat-justified" role="tab" aria-controls="pills-pubchat-justified" aria-selected="false"><i class="feather icon-layers"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" id="pills-chat-tab-justified" data-toggle="pill" onclick="initChatList()" href="#pills-chat-justified" role="tab" aria-controls="pills-chat-justified" aria-selected="true"><i class="feather icon-message-circle"></i></a>
                </li>
                <li class="nav-item">
    ...
    <div class="chat-rightbar">
        ...
        <div class="chat-detail">
            <div class="chat-head" style="z-index: 1041;background-color: #b8eed0;" >
                    ...
                    <div class="col-12">
                        <ul class="list-unstyled mb-0">
                            <li class="media">
                                ...
                                <div class="input-group">
                                    <h5 id="cur-chat-user-name">Chat Home</h5>
                                ...
                                <div class="input-group-append">
                                    <div class="dropdown" >
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="chatDropdown">
                                            ...
                                            <a class="dropdown-item font-14" href="#" id="view-group-info">查看聊天室信息</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="chat-bottom" style="background-color: #b8eed0">
                <div class="chat-messagebar">
                    <form onkeydown="if(event.keyCode==13)return false;">
                        <div class="input-group">
                            ...
                            -->
                            <div contenteditable="true" class="form-control will-send-msg-content" style="background-color: white;border-radius: 20px" id="will-send-msg-content" placeholder="" aria-label="Text"></div>
                            <div class="input-group-prepend" style="margin-left: 10px;">
                                <#--                                    <a href="javascript:void(0)" ><i class="feather icon-layers"  id="button-addonmic"></i></a>-->
                                <a href="javascript:void(0)" >
                                    <img width="23px" height="23px" src="/home/images/smile.svg" alt="avatar" id="button-addonmic">
                                </a>
                            </div>
        ...
        <div class="chat-user-info" id="view-chat-user-info"  style="z-index: 1042">
            ...
            <div class="chat-user-body">
                <div class="userbar">
                    ...
                    <h5 id="view-user-info-remark">飞信</h5>
                    <p class="mb-0" id="view-user-info-desc">https://www.byx.com</p>
                </div>
                <div class="user-detail">
                    ...
                    <div class="user-about">
                        ...
                        <h6 class="my-3" id="view-user-info-email"><i class="feather icon-mail mr-2"></i>2239329914@qq.com</h6>
                    ...
                    <div class="user-setting">
                        <div class="row align-items-center pb-3" style="text-align:center;">
                            <div class="col-12">
                                <#--                                    <input type="button" class="btn btn-warning" id="clear-friend-msg" value="清空聊天记录" style="width:100%;">-->
                                <button type="button" id="clear-friend-msg" class="layui-btn layui-btn-fluid layui-btn-warm">清空聊天记录</button>

                            </div>
                        </div>
                        <div class="row align-items-center pb-3" style="text-align:center;">
                            <div class="col-12">
                                <#--                                    <input type="button" class="btn btn-danger" id="delete-friend-btn" value="解除好友关系" style="width:100%;">-->
                                <button type="button" id="delete-friend-btn" class="layui-btn layui-btn-fluid layui-btn-danger">解除好友关系</button>
                            </div>
                        </div>
                        <div class="row align-items-center pb-3" style="text-align:center;">
                            <div class="col-12">
                                <#--                                    <input type="button" id="start-chat-btn" class="btn btn-primary" value="立即发送消息" style="width:100%;">-->
                                <button type="button" id="start-chat-btn" class="layui-btn layui-btn-fluid">立即发送消息</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="chat-user-info" id="view-chat-group-info"   style="z-index: 1042">
...
<!--CryptoJS jsencrypt -->
<script src="/home/js/cryptojs.js"></script>
<script src="/home/js/jsencrypt.min.js"></script>
<script src="/home/js/aesUtil.js"></script>
<script src="/home/js/rsaUtil.js"></script>
<#--script src="./cryptojs.js"></script>-->
<#--<script src="./jsencrypt.min.js"></script>-->
<#--<script src="./aesUtil.js"></script>-->
<#--<script src="./rsaUtil.js"></script>
    <!-- End js -->
</body>
<script type="text/javascript">
    ...
    var websocket;
    setTimeout(function(){
        websocket = buildWebSocket(${base_account.id});
    },500);
    $(document).ready(function(){
        ...
        $("#button-addonmic").click(function(){
            $("#emoji_container_1").css({'top':'','left':'','bottom':'45px','right':'10px'});
        });
        //用户状态改变
        ...
        //点击查看新的加聊天室请求
        $("#a-pub-friend-request-tab").click(function(){
            $.get('group_request_list',{},function(data,status,xhr){
                if(data == ''){
                    layer.msg('暂无加聊天室请求！');
                }
                $("#show-new-group-request-list").html(data);
            });
            $("#new-group-request-tab-show").modal("toggle");
        });
        //获取加聊天室请求数
        getNewGroupRequestCount();
        setInterval(getNewGroupRequestCount,60000);
        //批量通过加聊天室请求
        $(".new-group-request-handle-btn").click(function(){
            var checkedUsers = $("input.reciever-add-user-request[type='checkbox']:checked");
            if(checkedUsers.length < 1){
                layer.msg('请选择需要操作的用户！');
                return;
            ...
            handleGroupRequest(fqids.toString(),aids.toString(),$(this).attr('status'));
        });
        ...
        $("#create-group-submit-btn").click(function(){
            ...
            ajaxRequest('create_group_chat','post',postData,function(data){
                layer.msg('创建成功');
                getFriendList();
                sendMsg(websocket,{msg:accounts.toString(),toId:0,fromId:${base_account.id},chatType:'event',msgType:'refresh_friend_list'});
                $("#createGroup").modal("toggle");
            },function(data){
                console.log(data);
                layer.msg(data.msg);
        ...
        //点击创建公共聊天室的提交按钮
        $("#create-pub-group-submit-btn").click(function(){
            var checkedUsers = $("#selected-chat-pub-group-users").children("div.avatar");
            // if(checkedUsers.length < 1){
            //     layer.msg('聊天室至少需要选择1个用户哦！');
            //     return;
            // }
            var postData = {};
            postData.name = $("#pubgroupName").val();
            postData.info = $("#pubgroupDesc").val();
            if(postData.name == ''){
                layer.msg('请填写聊天室名称！');
                return;
            }
            ...
            ajaxRequest('create_group_chat','post',postData,function(data){
                layer.msg('创建成功');
                getPubGroupList();
                sendMsg(websocket,{msg:accounts.toString(),toId:0,fromId:${base_account.id},chatType:'event',msgType:'refresh_group_list'});
                $("#createPubGroup").modal("toggle");
            },function(data){
                console.log(data);
                layer.msg(data.msg);
            });
        ...
        //点击创建公共聊天室按钮
        $("#create-pub-group-chat-btn").click(function(){
            // $.get('group_friend_list',{from:1},function(data,status,xhr){
            //     if(data == ''){
            //         layer.msg('你真可怜，没有一个好友！');
            //     }
            //     $("#create-pub-group-chat-show-friends").html(data);
            // });
            // $("#selected-chat-pub-group-users").children().remove();
            $("#createPubGroup").modal("toggle");
        });
        ...
        $("#button-addonsend").on('click',function(){
            ...
            if($(this).attr('msg-type') == 'single'){
                ...
                var friendAccountId = $("#focus-view-friend-account-id").val();
                sendMsg(websocket,{msg:msg,toId:friendAccountId,fromId:${base_account.id},chatType:'single',msgType:'text'});
            ...
            if($(this).attr('msg-type') == 'group'){
                ...
                sendMsg(websocket,{msg:msg,toId:groupId,fromId:${base_account.id},chatType:'group',msgType:'text'});
    ...
    function getNewGroupRequestCount(){
        ajaxRequest('get_new_group_request_count','post',{},function(data){
            if(data.data != 0){
                $("#show-new-group-request-num").html('加聊天室请求<span class="badge badge-danger ml-2" >'+data.data+'</span>');
                $("#show-new-group-request-text").text('有' + data.data + '个用户申请加聊天室!');
            }else{
                $("#show-new-group-request-num").html('加聊天室请求');
                $("#show-new-group-request-text").text('没有用户申请加聊天室!');
            }
        },function(data){
            console.log(data);
            layer.msg(data.msg);
    ...
    function handleFriendRequest(fqids,aids,type){
        ajaxRequest('handle_friend_request','post',{friendRequestIds:fqids,status:type},function(data){
            ...
            if(type == '1'){
                ...
                //发送广播消息来更新对方的好友列表
                sendMsg(websocket,{msg:aids,toId:0,fromId:${base_account.id},chatType:'event',msgType:'refresh_friend_list'});
    ...
    function handleGroupRequest(fqids,aids,type){
        ajaxRequest('handle_group_request','post',{friendRequestIds:fqids,status:type},function(data){
            layer.msg('操作成功！');
            $("#new-group-request-tab-show").modal("toggle");
            getNewGroupRequestCount();
            if(type == '1'){
                //批量通过用户，此时需要告知对方已经同意好友请求
                //发送广播消息来更新对方的好友列表
                sendMsg(websocket,{msg:aids,toId:0,fromId:${base_account.id},chatType:'event',msgType:'refresh_group_list'});
    ...
    function getPubGroupList(){
        $.get('pubGroup_list',{},function(data,status,xhr){
            if(data == ''){
                layer.msg('暂无公共聊天室');
            }
            $("#pub-friend-request-tab").nextAll("a.nav-link").remove();
            $("#pub-friend-request-tab").after(data);
        });
    }
    function changeTop(id,type,flag){
        var allChatTapInfo = getALLChatTapInfoFromLocal();
        if(type == 'group'){
            var currentChatTap = allChatTapInfo['group_'+id];
            currentChatTap.flag = flag;
    ...
    function toTop(friendId){
        // $("#chat-list-tab-top").append($("#Achat-"+friendId+"-tab"));
        $("#chat-list-tab-top").append($("#chat-"+friendId+"-tab"));
        changeTop(friendId,'single','true')
    }
    function toGroupTop(friendId){
        // $("#chat-list-tab-top").append($("#Agroup-chat-"+friendId+"-tab"));
        $("#chat-list-tab-top").append($("#group-chat-"+friendId+"-tab"));
        changeTop(friendId,'group','true')
    }
    function toBottom(friendId){
        // $("#chat-list-tab").append($("#Achat-"+friendId+"-tab"));
        $("#chat-list-tab").append($("#chat-"+friendId+"-tab"));
        changeTop(friendId,'single','false')
    }
    function toGroupBottom(friendId){
        // $("#chat-list-tab").append($("#Agroup-chat-"+friendId+"-tab"));
        $("#chat-list-tab").append($("#group-chat-"+friendId+"-tab"));
        changeTop(friendId,'group','false')
        ...
        for(var i=0;i<f.length;i++){
            ...
            if(suffix == 'png'||suffix == 'jpg'||suffix == 'jpeg'||suffix == 'gif'){
                ...
                uploadMuiltFileToServer('/upload/upload_photo',formData,function(data){
                    sendMsg(websocket,{msg:'[图片]'+filename,toId:friendAccountId,fromId:${base_account.id},chatType:msgType,msgType:'img',attachUrl:data.data});
            ...
            uploadMuiltFileToServer('/upload/upload_file',formData,function(data){
                ...
                if(suffix == 'mp3'){
                    ...
                    sendMsg(websocket,{msg:filename,toId:friendAccountId,fromId:${base_account.id},chatType:msgType,msgType:'audio',attachUrl:data.data});
                    return;
                }
                if(suffix == 'mp4' || suffix == 'rmvb' || suffix == '3gp' || suffix == 'avi' || suffix == 'flv' || suffix == 'mkv'){
                    sendVideoMsg(filename,data.data,sendId,msgType);
                    sendMsg(websocket,{msg:filename,toId:friendAccountId,fromId:${base_account.id},chatType:msgType,msgType:'video',attachUrl:data.data});
                    return;
                }
                sendFileMsg(filename,data.data,filesize,getPicBySuffix(suffix),sendId,msgType);
                sendMsg(websocket,{msg:filename,toId:friendAccountId,fromId:${base_account.id},chatType:msgType,msgType:'file',attachUrl:data.data,attachSize:filesize});
            },function(data){
                if(!isJson(data)){
                    data = $.parseJSON(data);
                }
    ...
    function initChatList(){
        // $.get('chatList',{},function(data,status,xhr){
        //     if(data == ''){
        //         layer.msg('你真可怜，没有一个好友！');
        //     }
        // });
