...
<title>${siteName!""}|聊天室管理-${title!""}</title>
                ...
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      聊天室名 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">聊天室名</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入聊天室名">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                        	<a href="javascript:void(0)" data-toggle="tooltip" title="点击查看聊天室成员" onclick="showMembers(${group.id})">${group.curPeople}</a>
                        </td>
                        <td style="vertical-align:middle;" >${group.notice!""}</td>
                        <td style="vertical-align:middle;" >${group.info!""}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${group.createTime?string("yyyy-MM-dd HH:mm:ss")}</font></td>
                      </tr>
                    </#list>
                    <#else>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">查看聊天室用户</h4>
      </div>
