...
<body>
<div class="row lyear-wrapper" style="background: url('/admin/images/img-slide-4.jpg')">
    ...
    <div class="login-center">
      ...
      <form id="login-form" method="post">
        ...
        <div class="form-group">
          <button class="btn btn-block btn-primary" style="background-color: #007bffc2" type="button" id="submit-btn">立即登录</button>
        </div>
      </form>
      <hr>
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2023 . All right reserved</p>
      </footer>
    </div>
  </div>
</div>
